...
public final class ModItems {
    ...
    public static final RegistrySupplier<Item> KEY_WAY_MOLD = registerItem("key_way_mold", () -> new Item(new Item.Settings().arch$tab(ModItemGroup.TAB_RETRIAL_KEY).maxCount(1)));
